...
from Model_it_1 import PersonModel1
from mesa.visualization.modules import CanvasGrid
...
simulation_params = {
    "number_of_agents": UserSettableParameter("slider", "Number of agents", 3, 1, 200, 1, description = "choose number of agents"),
    "width": NUMBER_OF_CELLS,
    "height": NUMBER_OF_CELLS,
}

def agent_potrayal(agent):
    potrayal = {"Shape": "circle", "Filled": "true", "r": 0.5}
...
server = ModularServer(PersonModel1, [grid, chart, chart2], "Money Model", simulation_params)        
server.port = 8521
server.launch()